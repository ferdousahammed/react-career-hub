...
const Banner = () => {
  return (
    <div className="transform -translate-y-24 w-screen bg-[linear-gradient(90deg,_rgba(126,_144,_254,_0.05)_0%,_rgba(152,_115,_255,_0.05)_100%)]">
      <div className="flex items-center justify-between lg:gap-16 gap-5 mx-[5%] lg:mx-[12%]">
        <div className="flex flex-col gap-6 lg:max-w-lg lg:mt-36 mt-28">
          <h3 className="font-extrabold lg:text-7xl text-4xl leading-[3rem] lg:leading-[6.25rem]">
        ...
        <div className="lg:mt-36 mt-28 lg:block hidden self-end">
